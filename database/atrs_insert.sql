...
INSERT INTO ticket (flight_num, airline_name, customer_email) 
VALUES (1, 'China Eastern', 'customer3@example.com'),
       (1, 'China Eastern', 'customer2@example.com'), 
       (2, 'China Eastern', 'customer2@example.com'),
       (3, 'China Eastern', 'customer1@example.com'),
       (4, 'American Airlines', 'customer1@example.com'),
       (5, 'Delta Air Lines', 'customer4@example.com'),
       (5, 'Delta Air Lines', 'customer3@example.com');
